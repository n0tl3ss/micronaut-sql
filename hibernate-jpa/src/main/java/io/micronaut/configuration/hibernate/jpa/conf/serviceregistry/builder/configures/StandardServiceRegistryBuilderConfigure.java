 ...
 * @since 4.5.0
 */
@Indexed(StandardServiceRegistryBuilderConfigure.class)
public interface StandardServiceRegistryBuilderConfigure {
     ...
     */
    void configure(JpaConfiguration jpaConfiguration, StandardServiceRegistryBuilder standardServiceRegistryBuilder);
